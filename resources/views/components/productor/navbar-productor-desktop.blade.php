...
<nav class="hidden md:flex navbar bg-base-100 shadow-lg px-8">
  ...
  <div class="flex flex-1 justify-center">
    <ul class="menu menu-horizontal p-0 text-md">
      ...
      <li><a href="{{ route('localidad') }}" wire:navigate class="hover:bg-gray-200 hover:text-black">
          <img src="{{ asset('storage/images/icons/nicaragua.png') }}" class="filter invert" />
          Comarcas
        </a>
      </li>
      <li>
        <a href="{{ route('productor') }}" wire:navigate class="bg-primary text-white hover:bg-gray-200 hover:text-black">
          <img src="{{ asset('storage/images/icons/agricultor.png') }}" class="filter invert" />
          Productores
        </a>
      </li>
