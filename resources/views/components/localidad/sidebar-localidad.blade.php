<!-- SIDEBAR -->
<div class="w-64 min-h-screen bg-base-200 flex flex-col drawer lg:drawer-open" x-data="{ show: false }"
    x-init="setTimeout(() => show = true, 300)" x-show="show" x-transition:enter="transition ease-out duration-500"
